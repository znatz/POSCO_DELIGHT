    ...
    <script type="text/javascript">
        jQuery(document).ready(function () {
            ...
            $('#ref_seller').focusout(function () {
                queryParam = $(this).val();
                phpCode = 'require_once dirname(__FILE__)."/../mapping/seller_class.php";echo var_dump(Seller::get_distinct_seller_chrID());';
                $.post('utils/show_list.php', {"phpCode":phpCode},function (data) {
                    console.log(data);
                    $("#back_sellers").text(data.toString());
                })
            });
        ...
        <div id="user_list">
            <form method="post" id="list" action="">
                ...
                foreach ((array)$contents as $row) {
                    ...
                    echo '<td width="40px;" style="text-align:center;">' . $row->chrID . '</td>';
                    echo '<td width="40px;" style="text-align:center;">' . $row->chrClass_ID . '</td>';
                    echo '<td width="40px;" style="text-align:left;">' . $row->chrCode . '</td>';
                    echo '<td width="40px;" style="text-align:left;">' . $row->chrName . '</td>';
                    echo '<td width="40px;" style="text-align:left;">' . $row->chrKana . '</td>';
                    echo '<td width="40px;" style="text-align:center;">' . $row->chrSeller_ID . '</td>';
                    echo '<td width="40px;" style="text-align:center;">' . $row->chrMaker_ID . '</td>';
                    echo '<td width="40px;" style="text-align:center;">' . $row->chrGroup_ID . '</td>';
                    echo '<td width="40px;" style="text-align:center;">' . $row->chrUnit_ID . '</td>';
                    echo '<td width="40px;" style="text-align:left;">' . $row->chrColor . '</td>';
                    echo '<td width="40px;" style="text-align:left;">' . $row->chrSize . '</td>';
                    echo '<td width="40px;" style="text-align:left;">' . $row->chrComment1 . '</td>';
                    echo '<td width="40px;" style="text-align:left;">' . $row->chrComment2 . '</td>';
                    echo '<td width="40px;" style="text-align:right;">' . $row->intCost . '</td>';
                    echo '<td width="40px;" style="text-align:right;">' . $row->intPrice . '</td>';
