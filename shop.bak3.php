...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="./css/table.bak.css">
    <script type="text/javascript">
        jQuery(document).ready(function () {
            ...
            $('#myTable tbody td.long_cell').click(function() {
                $(this).toggleClass('hovered');
            });

            $('#myTable tbody td.hovered').click(function() {
    ...
    <div class="pageContent">
        ...
        <div id="user_list">
            <form method="post" id="list" action="">
                ...
                echo '<table id="myTable" style="width:1090px;border:0;margin:0; position:relative;padding:0;border-radius:5px;" class="search_table tablesorter">';
                echo '<thead><tr>';
                ...
                foreach ($contents as $row) {
                    ...
                    echo '<td style="width:30px;">' . $row->chrID . '</td>';
                    echo '<td style="width:80px;">' . $row->chrName . '</td>';
                    echo '<td style="text-align:center;width:50px;">' . $row->chrPost . '</td>';
                    echo '<td style="text-align:left;width:100px;" class="long_cell" id="long_cell">'. $row->chrAddress . '</td>';
                    echo '<td style="width:80px;">' . $row->chrAddressNo . '</td>';
                    echo '<td style="text-align:center;width:80px;">' . $row->chrTel . '</td>';
                    echo '<td style="text-align:center;width:80px;">' . $row->chrFax . '</td>';
                    echo '<td style="text-align:center;width:30px;">' . $row->intDisplayOrder . '</td>';
                    echo '<td style="text-align:center;width:30px;"><input type="radio" onclick="javascript: submit()" name="targetID" id="targetID" value="' . $row->chrID . '"/></td>';
                    echo '<td style="text-align:center;width:10px;"><input class="center_button hvr-fade delete_button" style="width:50px; height:25px; margin:0;padding:0;font-weight:normal;" type="submit" name="' . $row->chrID . '" value="削除"/></td>';
                    echo '</tr>';
                }
                echo '</tbody></table>';
